...
public record UserGetResponse(String id, String login, String encryptedPassword, List<RoleType> roles) {
    public static UserGetResponse of(User user) {
        ...
        return new UserGetResponse(user.getId(), user.getLogin(), user.getPassword(), roles);
    }
}
